-- Kitchen Monitor Database Schema Modifications (MySQL対応版)
...
-- Add indexes for performance (MySQL対応版)
...
-- MySQL対応: WHERE句を削除してシンプルなインデックスに変更
CREATE INDEX idx_order_details_status_created ON order_details(status, created_at);
