...
-- ===== 2025-05-12 Order Session 機能追加 =====
-- 新規セッションテーブル
CREATE TABLE IF NOT EXISTS order_sessions (
    id CHAR(21) PRIMARY KEY,
    room_number VARCHAR(20) NOT NULL,
    square_item_id VARCHAR(255) NULL COMMENT 'Squareの商品ID',
    is_active BOOLEAN DEFAULT TRUE,
...
-- 既存テーブルに order_session_id 列を追加
ALTER TABLE line_room_links  
    ADD COLUMN order_session_id CHAR(21) NULL AFTER room_number,
    ADD INDEX(order_session_id);
...
ALTER TABLE order_details  
    ADD COLUMN order_session_id CHAR(21) NULL AFTER order_id,
    ADD INDEX(order_session_id); 