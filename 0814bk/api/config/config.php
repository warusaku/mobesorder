...
define('SQUARE_ACCESS_TOKEN', 'EAAAl8yo-W9q8gyLCEaFHpcwkgzp2q9d1N54kQmSwRx5kIaKyQq90D5q3l7jtzz_');
...
define('SQUARE_WEBHOOK_SIGNATURE_KEY',
       'CeWJJuQ7mPtN4aMka1y6RA');
...
define('BASE_URL', 'https://mobes.online/api');
...
if (!headers_sent()) {
    ...
    // ヘッダー送信後にこのファイルが読み込まれた場合はログに記録
    error_log('Warning: Cannot set session parameters after headers sent - ' . basename($_SERVER['SCRIPT_FILENAME']));
}
